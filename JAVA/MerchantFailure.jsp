    ...
    <div id="cs-main-body" class="cs-text-size-default pad-bottom">
      <div class="col-sm-9  equalheight-col pad-top">
        <div style="padding-bottom: 50px;">
          ...
          <div class="row">
            <div class="col-sm-12">
              <legend>Error occured during payment. Please try again.</legend>
            </div>
            <div class="col-sm-12">
              <legend><strong>Error Code : </strong><%=fields.get("ReasonCode").toString() %></legend>
            </div>
            <div class="col-sm-12">
              <legend><strong>Error Message : </strong><%=fields.get("ResponseText").toString() %></legend>
            </div>

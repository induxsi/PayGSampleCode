...
<body> 
    <div class="container">
        ...
        <form id="payg_request_form" method="post" action="sendRequest.jsp">
            <div class="row one">
                ...
                <div class="col-sm-3 form-group">
                    ...
                    <input type="number" class="form-control" id="RequestUniqueId" name="RequestUniqueId"  value=""/>
                </div>
                ...
                <div class="col-sm-3 form-group">
                    ...
                    <input type="text" class="form-control" id="ResponseRedirectUrl" name="ResponseRedirectUrl" value="http://localhost:8085/Java/MerchantSuccess.jsp" />
                </div>
                <div class="col-sm-3 form-group">
                    <label for="CancelRedirectUrl">Cancel Redirect Url :</label>
                    <input type="text" class="form-control" id="CancelRedirectUrl" name="CancelRedirectUrl" value="http://localhost:8085/Java/MerchantFailure.jsp" />
                </div>
    ...
    $(document).ready(function(e) {
       $("#OrderId").val(Math.floor((Math.random() * 100000) + 1));
       $("#RequestUniqueId").val(Math.floor((Math.random() * 100000) + 1))
    }); 
     $(function() {
